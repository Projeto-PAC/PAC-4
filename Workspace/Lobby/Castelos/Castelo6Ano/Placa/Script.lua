...
local TEXTO_MSG = "ARENA DE NIVELAMENTO 6º ANO!"

-- 📏 DISTÂNCIAS INTERNAS
local DISTANCIA_LOGO_TEXTO = 25   -- Espaço entre o logo e o texto no mesmo bloco
local ESPACO_ENTRE_REPETICOES = 220 -- Espaço entre o fim de um ciclo e o início do outro

-- ⚡ MOVIMENTO
local VELOCIDADE = 0.0010 
local ALTURA_FONTE = 0.4 -- 40% da altura da placa
...
local function criarVagao(nome)
	...
	t.Text = TEXTO_MSG
	t.TextScaled = true
	t.TextColor3 = Color3.fromRGB(200, 55, 55)
