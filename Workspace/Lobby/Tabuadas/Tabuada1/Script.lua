...
-- ==========================================================
local TABUADA_PARA_COMECAR = 2  -- Onde o desafio inicia 
...
local function iniciarArenaPro()
	...
	while true do
		...
		atualizarTexto(displayPrincipal, "DESTINO PARA ARENA 6º  TABUADA DE: " .. n)
		...
		for segundosRestantes = TEMPO_DE_TROCA, 0, -1 do
			-- A MÁGICA ESTÁ AQUI: "\n" pula a linha
			local textoDuplo = "DESTINO PARA ARENA 6º ANO" .. "" .. "\nTABUADA DE: " .. n .. " TEMPO: " .. segundosRestantes .. "s"
